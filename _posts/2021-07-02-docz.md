...
```
Then open 
<a href="file:///tmp/SlothCreatorSite/documentation/slothcreator.html">file:///tmp/SlothCreatorSite/documentation/slothcreator.html</a>.
...
[directly open](file:///tmp/SlothCreatorSite/documentation/slothcreator.html)ed in the browser,
e.g.
```bash
...
(or doesn't support JavaScript, like say lynx),
