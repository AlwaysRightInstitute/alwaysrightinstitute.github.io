...
> Note(2020-12-27): While still useful, this article covers an earlier version
> that used SwiftXcode, a system to use SPM packages in Xcode when
...
<center><a href="{{ site.baseurl }}/images/swiftobjects/xcode12/19-tool-import-SwiftObjects-prebuild.png"
  ><img src=
  "{{ site.baseurl }}/images/swiftobjects/xcode12/19-tool-import-SwiftObjects-prebuild-cut.png" 
  /></a></center>
...
class Application: WOApplication {
  ...
  override init() {
    ...
    defaultRequestHandler =
      WOComponentRequestHandler(application: self)
  }
}
```
