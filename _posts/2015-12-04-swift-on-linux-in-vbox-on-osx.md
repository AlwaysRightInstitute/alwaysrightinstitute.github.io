...
Lets do this:
    ...
    tar zxf swift-DEVELOPMENT-SNAPSHOT-2016-02-25-a-ubuntu15.10.tar.gz
    export PATH="~/swift-not-so-much/swift-DEVELOPMENT-SNAPSHOT-2016-02-25-a-ubuntu15.10/usr/bin:$PATH"
    popd
...
Sample `config.make`:
    ...
    ifeq ($(UNAME_S),Darwin)
      ...
      SWIFT_SNAPSHOT=swift-DEVELOPMENT-SNAPSHOT-2016-02-25-a-$(OS)$(VER)
