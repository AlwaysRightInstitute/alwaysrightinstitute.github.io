...
Lets do this:
    ...
    export PATH="~/swift-not-so-much/swift-DEVELOPMENT-SNAPSHOT-2016-02-08-a-ubuntu15.10/usr/bin:$PATH"
    popd
...
Sample `config.make`:
    ...
    ifeq ($(UNAME_S),Darwin)
      ...
      SWIFT_SNAPSHOT=swift-DEVELOPMENT-SNAPSHOT-2016-02-08-a-$(OS)$(VER)
